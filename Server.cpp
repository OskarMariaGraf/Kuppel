...
int KameraWolken1 = 0;
int KameraWolken2 = 0;
const char *WritePipeRegen = "/tmp/RegenRinne1";
const char *ReadPipeRegen = "/tmp/RegenRinne2";
...
int main(int argc, char *argv[]) {
     ...
     while (1) {
          ...
          while (1) {
               RegenRinne1 = open(WritePipeRegen, O_RDWR | O_NONBLOCK);    //RegenPipe
               RegenRinne2 = open(ReadPipeRegen, O_RDWR | O_NONBLOCK);
